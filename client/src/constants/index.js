...
export const TRAVEL_STYLES = [
  { id: "budget", label: "Budget", desc: "Hostels, street food", icon: "💰", color: "bg-emerald-50 border-emerald-200 text-emerald-700" },
  { id: "comfort", label: "Comfort", desc: "3★ hotels, comfort", icon: "✨", color: "bg-amber-50 border-amber-200 text-amber-700" },
  { id: "luxury", label: "Luxury", desc: "Premium stays", icon: "👑", color: "bg-violet-50 border-violet-200 text-violet-700" },
];
